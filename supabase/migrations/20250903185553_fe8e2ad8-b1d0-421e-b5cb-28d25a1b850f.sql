-- 2. Create database views for analytics and insights (fixed ambiguous columns)
...
-- Daily streaks view - tracks consecutive days with activity (fixed ambiguous columns)
