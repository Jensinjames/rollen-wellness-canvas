...
interface OptimizedCategoryProgressCardProps {
  category: Category;
  actualTime: number;
...
const OptimizedCategoryProgressCard: React.FC<OptimizedCategoryProgressCardProps> = memo(({
  category,
  actualTime,
  subcategoryTimes = {},
  className = ''
...
OptimizedCategoryProgressCard.displayName = 'OptimizedCategoryProgressCard';

export { OptimizedCategoryProgressCard };
